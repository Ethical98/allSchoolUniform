...
export const USER_OTP_SUCCESS = 'USER_OTP_VERIFICATION_SUCCESS';
export const USER_OTP_FAIL = 'USER_OTP_VERIFICATION_FAIL';
export const USER_OTP_SENT = 'USER_OTP_SENT';
export const USER_OTP_RESET = 'USER_OTP_RESET';
export const USER_OTP_CANCEL = 'USER_OTP_CANCEL';
...
export const USER_PASSWORD_RESET_CLEAR = 'USER_PASSWORD_RESET_CLEAR';
