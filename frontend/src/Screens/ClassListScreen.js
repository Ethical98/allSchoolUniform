...
import { createClass, deleteClass, listClasses, updateClass } from '../actions/classActions';
    ...
    return (
        <AdminPageLayout>
            <Meta
                ...
                keyword={'cheap,sell,buy,allschooluniform,new,buyback,unform,online,classes,school'}
            />
