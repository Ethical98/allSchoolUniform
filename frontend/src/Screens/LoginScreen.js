...
import { loginByPhone, login, getOTP, configureCaptcha, getOtpWithEmail } from '../actions/userActions';
        ...
        <PageLayout>
            ...
            <FormContainer>
                ...
                {loading || otpLoading ? (
                    ...
                    invalidInputError && <Message variant="danger">{invalidInputError}</Message>
                )}
                {!continueClicked ? (
                    <Form noValidate validated={validated} onSubmit={onSubmitHandlerFormOne}>
                        <Form.Group controlId="emailOrPhone" className="mb-3">
                            <FloatingLabel controlId="emailOrPhone" label="Email or Phone" className="mb-3">
                                <Form.Control
                                    value={inputValue}
                                    required
                    ...
                    <Form noValidate validated={validated} onSubmit={submitHandler}>
                        ...
                        <Row className="py-3">
                            <Col className="text-center">
                                ...
                                <Button variant="dark" className="col-12 mb-3" onClick={getOtpHandler}>
