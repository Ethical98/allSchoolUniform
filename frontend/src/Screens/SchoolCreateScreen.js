...
import { SCHOOL_CREATE_RESET, SCHOOL_IMAGE_UPLOAD_RESET, SCHOOL_NAME_LIST_RESET } from '../constants/schoolConstants';
...
const SchoolCreateScreen = ({ history }) => {
    ...
    return (
        <AdminPageLayout>
            <Meta title={'Add School - AllSchoolUniform'} description={'Add New School Page'} />
