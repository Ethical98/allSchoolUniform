...
const ForgotPasswordScreen = ({ history }) => {
    ...
    useEffect(() => {
        if (linkSentSuccess) {
            setMessage('We have sent you a link on your email address to reset your password');
        }
    }, [linkSentSuccess]);
                ...
                <Card>
                    ...
                    <Card.Body>
                        <Form onSubmit={submitHandler}>
                            <Form.Group>
                                <Form.Label>Please enter the email address to reset your password.</Form.Label>
                    ...
                    <Card.Footer className="text-center">
                        <Link to="/login">
                            <span className=" btn btn-outline-dark text-center">Back To Login</span>
                        </Link>
                    </Card.Footer>
                </Card>
            </FormContainer>
