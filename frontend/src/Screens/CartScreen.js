    ...
    return (
        <PageLayout>
            <Meta
                ...
                keyword={'cheap,sell,buy,allschooluniform,new,buyback,unform,online,cart'}
            />
            <Row>
                                    ...
                                    cartItems.map(item => (
                                        <ListGroup.Item key={item._id}>
                                            <Row className="g-2">
                                                ...
                                                <Col xs={2}>₹{getDiscountedPrice(item.price, item.disc)}</Col>
                                                <Col xs={2}>
                ...
                <Col md={4}>
                    <Card>
                        <ListGroup variant="flush">
                            <ListGroup.Item>
                                <h2>
                                    Subtotal ({cartItems && cartItems.reduce((acc, item) => acc + item.qty, 0)}) Items
                                </h2>
                                ₹
                                {cartItems &&
                                    cartItems
                                        .reduce(
                                            (acc, item) => acc + item.qty * getDiscountedPrice(item.price, item.disc),
                                            0
                                        )
                                        .toFixed(2)}
                            </ListGroup.Item>
