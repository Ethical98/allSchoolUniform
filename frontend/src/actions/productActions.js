...
// export const addNewProductSize =
//   (sizeToAdd, id) => async (dispatch, getState) => {
//     try {
//       dispatch({ type: PRODUCT_NEW_SIZE_ADD_REQUEST });
//       console.log(id);
//       const {
//         userLogin: { userInfo },
//       } = getState();
...
//       const { data } = await axios.post(
//         `/api/products/${id}/sizes/add`,
//         { sizeToAdd, id },
//         config
//       );

//       dispatch({
//         type: PRODUCT_NEW_SIZE_ADD_SUCCESS,
//         payload: data,
//       });
//     } catch (error) {
//       dispatch({
//         type: PRODUCT_NEW_SIZE_ADD_FAIL,
//         payload:
//           error.response && error.response.data.message
//             ? error.response.data.message
//             : error.message,
